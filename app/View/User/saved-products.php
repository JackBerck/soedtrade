                        ...
                        <?php foreach ($products as $product) : ?>
                            <div class="max-w-[300px] aspect-square bg-white border border-gray-200 rounded-lg shadow relative">
                                <div class="absolute top-1 right-1 md:top-2 md:right-2 flex gap-2 items-center z-10">
                                    <a href="/users/manage-products/update-product/<?= $product->product_id ?>"
                                    ...
                                    <form action="/users/manage-products/delete-product" method="post"
                                          onsubmit="return verification()">
                                        <input type="hidden" name="postId" value="<?= $product->product_id ?>">
                                        <button type="submit"
