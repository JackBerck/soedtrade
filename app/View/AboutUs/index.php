...
$comments = [
    [
        "name" => "Anton Purwaji",
        "comment" => "Belanja di SoedTrade sangat memuaskan dengan layanan cepat dan produk berkualitas. Barang sampai dengan aman dan sesuai deskripsi. Terima kasih.",
        "stars" => 5,
        "image" => "/images/reviews/anton-purwaji.webp",
    ],
    [
        "name" => "Budi Santoso",
        "comment" => "Saya sangat puas dengan produk di SoedTrade. Kualitasnya sangat baik dan harganya terjangkau. Pelayanan yang diberikan juga sangat ramah dan responsif. Sangat direkomendasikan!",
        "stars" => 5,
        "image" => "/images/reviews/budi-santoso.webp",
    ],
    [
        "name" => "Rina Wijaya",
        "comment" => "Pengalaman berbelanja di SoedTrade sungguh menyenangkan. Produknya berkualitas tinggi dan pengirimannya cepat. Saya sangat puas dengan layanan yang diberikan. Terima kasih!",
        "stars" => 5,
        "image" => "/images/reviews/rina-wijaya.webp",
    ],
    [
        "name" => "Ahmad Abdullah",
        "comment" => "Saya sudah menjadi pelanggan setia SoedTrade selama bertahun-tahun. Produknya selalu berkualitas dan harganya tidak terkalahkan. Saya sangat merekomendasikan kepada semua orang!",
        "stars" => 5,
    ...
    <div class="container max-w-screen-xl">
        <div class="grid mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
            ...
            <div class="place-self-center lg:col-span-7">
                ...
                >
                    Platform perdagangan untuk komunitas Gensoed
                </h1>
                <p class="max-w-2xl mb-2 lg:mb-4 normal-font-size">
                    Dari kebutuhan sehari-hari hingga kemitraan bisnis, SoedTrade membantu mempermudah transaksi Anda dengan aman dan nyaman.
                </p>
                <a
                        href="index.php"
